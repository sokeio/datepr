...
export interface BaseOptions {
  ...
  */
  ...
  /*
    ...
    See https://chmln.github.io/datepr/formatting
  */
  dateFormat: string;
  ...
  /*
    ...
    See https://chmln.github.io/datepr/examples/#disabling-specific-dates */
...
By default, Flatpickr utilizes native datetime widgets unless certain options (e.g. disable) are used. */
  ...
  /* Disables all dates except these specified. See https://chmln.github.io/datepr/examples/#disabling-all-dates-except-select-few */
  ...
  See https://chmln.github.io/datepr/localization/ */
...
Use it along with "enableTime" to create a time picker. */
  ...
  /* Fires for every day cell in the calendar, where the fourth argument is the html element of the cell. See https://chmln.github.io/datepr/events/#ondaycreate*/
  ...
  /* Plugins. See https://chmln.github.io/datepr/plugins/ */
  plugins: Plugin[];
  ...
  */
  ...
  /* See https://chmln.github.io/datepr/examples/#datepr-external-elements */
  wrap: boolean;
}
